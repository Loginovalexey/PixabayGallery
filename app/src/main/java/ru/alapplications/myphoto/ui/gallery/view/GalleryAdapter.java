...
public class GalleryAdapter extends PagedListAdapter<Hit, GalleryAdapter.HitViewHolder> {
    ...
    public GalleryAdapter ( DiffUtil.ItemCallback<Hit> diffUtilCallback , OnItemClickListener onItemClickListener ) {
    ...
    class HitViewHolder extends RecyclerView.ViewHolder {
        ...
        HitViewHolder ( @NonNull final View itemView ) {
            ...
            itemLayout = itemView.findViewById ( R.id.itemGalleryLayout );
            picture = itemView.findViewById ( R.id.itemGalleryImageView );
